...
class SearchItems extends StatefulWidget {
  ...
  //receiving search item from homefragment screen search bar to here
...
class _SearchItemsState extends State<SearchItems> {
  ...
  Future<List<Clothes>> readSearchRecordsFound()
  async {
    List<Clothes> clothesSearchList = [];

    if(searchController.text !="")
    {
      //user must type something in the searchbar
      try
      {
        ...
        decoration: InputDecoration(
          prefixIcon: IconButton(
            onPressed: (){
              ...
              //update the state when user type a new keyword after any typedwords
              setState(() {
