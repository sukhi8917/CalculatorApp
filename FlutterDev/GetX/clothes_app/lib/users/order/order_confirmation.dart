...
class OrderConfirmationScreen extends StatelessWidget
{
  ...
  chooseImageFromGallery() async
  {
    ...
    {//it means it contain the correct image file
      //convert this image to bytes
  ...
  {
    //first we convert all data to json and then we send this bulk of data to mysql db

    //simply we convert this selected item list to a string
    ...
    try
    {
      var res = await http.post(
        ...
        body: order.toJson(base64Encode(imageSelectedByte)),//pas image in byte so we convert it in
      );
