...
class _OrderDetailsScreenState extends State<OrderDetailsScreen>
{
  ...
  //default value is saved in db is new and after user say it is received tha db update to received
  ...
  {
    //getting all clicked item details from db as name selectedItems
