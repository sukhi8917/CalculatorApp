...
class OrderNowScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          //display selected items from cartList
              ...
              children: deliverySystemNamesList.map((deliverySystemName)
              {
                return Obx(()=>
                    RadioListTile<String>(
                      ...
                      {
                        //means when user click on any other system
  ...
  {
    return Column(
      children: List.generate(selectedCartListItemInfo!.length, (index)
      {
        //getting each item from our list and assigning to it in eachSelectedItem Map
        Map<String,dynamic> eachSelectedItem = selectedCartListItemInfo![index];
        return Container(
          margin: EdgeInsets.fromLTRB(
            16,
            index == 0 ? 16 :8,
            16,
            index == selectedCartListItemInfo!.length -1 ? 16 :8,
          ),
